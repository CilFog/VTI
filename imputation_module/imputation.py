...
def generate_output_files_and_stats(G, imputed_paths, file_name, type, size, node_dist_threshold, edge_dist_threshold, cog_angle_threshold, trajectory_points, execution_time, add_execution_time):
    ...
    imputation_output_path = os.path.join(OUTPUT_FOLDER_RAW, f'skagen/{type}/{size}/{node_dist_threshold}_{edge_dist_threshold}_{cog_angle_threshold}/{file_name}')
    refined_output_path = os.path.join(OUTPUT_FOLDER_PROCESSED, f'skagen/{type}/{size}/{node_dist_threshold}_{edge_dist_threshold}_{cog_angle_threshold}/{file_name}')
